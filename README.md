# MicroTools
MicroTools implements an advanced computer vision algorithm permitting automated analysis of handheld vital microscopy (HVM) image sequences recorded of the human and porcine sublingual microcirculation.
